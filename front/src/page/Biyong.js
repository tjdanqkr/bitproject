  ...
  const OnSubmit = (e) => {
    ...
    fetch("/biyong", {
      ...
      .then((message) => {
        ...
        window.location.replace("/biyong2");
      });
  };
  return (
    <>
      <div className="box">
        <form>
          <table>
            <thead>
              <tr>
                <th className="title">초기 투자비용</th>
              </tr>
            </thead>

            <tbody>
              <tr>
                <th className="text">권리금</th>
                <th className="inputt">
                  <input
                    type="text"
                    name="g"
